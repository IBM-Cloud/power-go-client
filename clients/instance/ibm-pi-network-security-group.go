...
func (f *IBMPINetworkSecurityGroupClient) DeleteMember(id, memberId string) (models.Object, error) {
...
func (f *IBMPINetworkSecurityGroupClient) DeleteRule(id, ruleId string) (models.Object, error) {
