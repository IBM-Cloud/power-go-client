...
var apiURL string          // set in code, not ENV var
...
var timeoutAttempts = 500000000000000 // TIMEOUT_ATTEMPTS
...
const jobError = "Cannot find job status for job id %s with cloud instance %s\n"
...
// Snapshot
var snapshotName string        // SNAPSHOT_NAME
var snapshotDescription string //SNAPSHOT_DESCRIPTION
var snapshotInstanceID string  // SNAPSHOT_INSTANCE_ID
