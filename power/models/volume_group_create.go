...
type VolumeGroupCreate struct {
	...
	// Target CRN of the secondary workspace where the auxiliary data will reside; optional; if specified, the auxiliary volumes for the primary volumes getting added to the new volume group will be automatically onboarded into the secondary workspace and added to the corresponding auxiliary consistency group (auxiliary CG will get created if it does not already exist)
