...
func (o *PcloudVirtualserialnumberGetallReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /pcloud/v1/virtual-serial-number] pcloud.virtualserialnumber.getall", response, response.Code())
	}
}
...
func (o *PcloudVirtualserialnumberGetallOK) Error() string {
	...
	return fmt.Sprintf("[GET /pcloud/v1/virtual-serial-number][%d] pcloudVirtualserialnumberGetallOK %s", 200, payload)
}
...
func (o *PcloudVirtualserialnumberGetallBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pcloud/v1/virtual-serial-number][%d] pcloudVirtualserialnumberGetallBadRequest %s", 400, payload)
}
...
func (o *PcloudVirtualserialnumberGetallUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pcloud/v1/virtual-serial-number][%d] pcloudVirtualserialnumberGetallUnauthorized %s", 401, payload)
}
...
func (o *PcloudVirtualserialnumberGetallForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pcloud/v1/virtual-serial-number][%d] pcloudVirtualserialnumberGetallForbidden %s", 403, payload)
}
...
func (o *PcloudVirtualserialnumberGetallNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pcloud/v1/virtual-serial-number][%d] pcloudVirtualserialnumberGetallNotFound %s", 404, payload)
}
...
func (o *PcloudVirtualserialnumberGetallInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pcloud/v1/virtual-serial-number][%d] pcloudVirtualserialnumberGetallInternalServerError %s", 500, payload)
}
