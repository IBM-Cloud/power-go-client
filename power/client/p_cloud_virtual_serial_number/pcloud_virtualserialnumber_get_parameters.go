...
type PcloudVirtualserialnumberGetParams struct {
	...
	/* RetainedVsn.
	   ...
	   flag to filter only the retained VSNs
	*/
	RetainedVsn *bool

	/* VirtualSerialNumberID.

	   Virtual Serial Number
	*/
	VirtualSerialNumberID string
...
// WithRetainedVsn adds the retainedVsn to the pcloud virtualserialnumber get params
func (o *PcloudVirtualserialnumberGetParams) WithRetainedVsn(retainedVsn *bool) *PcloudVirtualserialnumberGetParams {
	o.SetRetainedVsn(retainedVsn)
	return o
}

// SetRetainedVsn adds the retainedVsn to the pcloud virtualserialnumber get params
func (o *PcloudVirtualserialnumberGetParams) SetRetainedVsn(retainedVsn *bool) {
	o.RetainedVsn = retainedVsn
}

// WithVirtualSerialNumberID adds the virtualSerialNumberID to the pcloud virtualserialnumber get params
func (o *PcloudVirtualserialnumberGetParams) WithVirtualSerialNumberID(virtualSerialNumberID string) *PcloudVirtualserialnumberGetParams {
	o.SetVirtualSerialNumberID(virtualSerialNumberID)
	return o
}

// SetVirtualSerialNumberID adds the virtualSerialNumberId to the pcloud virtualserialnumber get params
func (o *PcloudVirtualserialnumberGetParams) SetVirtualSerialNumberID(virtualSerialNumberID string) {
	o.VirtualSerialNumberID = virtualSerialNumberID
}
...
func (o *PcloudVirtualserialnumberGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.RetainedVsn != nil {

		// query param retained_vsn
		var qrRetainedVsn bool

		if o.RetainedVsn != nil {
			qrRetainedVsn = *o.RetainedVsn
		}
		qRetainedVsn := swag.FormatBool(qrRetainedVsn)
		if qRetainedVsn != "" {

			if err := r.SetQueryParam("retained_vsn", qRetainedVsn); err != nil {
				return err
			}
		}
	}

	// path param virtual_serial_number_id
	if err := r.SetPathParam("virtual_serial_number_id", o.VirtualSerialNumberID); err != nil {
		return err
	}
