...
// WithPvmInstanceID adds the pvmInstanceID to the pcloud virtualserialnumber get params
func (o *PcloudVirtualserialnumberGetParams) WithPvmInstanceID(pvmInstanceID *bool) *PcloudVirtualserialnumberGetParams {
	o.SetPvmInstanceID(pvmInstanceID)
	return o
}

// SetPvmInstanceID adds the pvmInstanceId to the pcloud virtualserialnumber get params
func (o *PcloudVirtualserialnumberGetParams) SetPvmInstanceID(pvmInstanceID *bool) {
